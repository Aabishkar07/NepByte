        ...
        >
          ...
          >
            ...
            >
              <p className="mb-6">
                NepByte is a{" "}
                <strong className="text-white">skilled and innovative IT Company</strong> in Kathmandu that
                provides comprehensive digital solutions to accelerate your business growth. We offer premium
                services including web development, mobile applications, SEO, UI/UX design, and digital marketing –
                all under one roof.
              </p>

              <p className="mb-6">
                Our expert team understands your unique business requirements. Whether you're a startup or an
                established enterprise, we create tailored solutions, enhance your online presence, and help you
